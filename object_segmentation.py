...
class ObjectSegmentation:
    ...
    def segment(self, bgr_image):
        ...
        segmented_image, df = self.draw_image(image, edges, rgb_image)

        return segmented_image, df
    
    # Draw borders around the objects
    def draw_image(self, image, edges, rgb_image):
        ...
        img_contours_blurred = rgb_image.copy()
